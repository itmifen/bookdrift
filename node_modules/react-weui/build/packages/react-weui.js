...
TextArea.propTypes = {
     ...
     *
     */
    showCounter: index$1.bool,
    /**
     * max character allow for textarea
     *
     */
    maxLength: index$1.number,
    defaultValue: index$1.string
};
...
Msg$1.propTypes = {
     ...
     *
     */
    extraHref: index$1.string,
    /**
     * deprecated property from 0.4.x
     *
     */
    extraText: index$1.string,
    /**
...
Swiper$1.propTypes = {
     ...
     *
     */
    threshold: index$1.number,
    /**
     * speed for the slide transition, number in ms
     *
     */
    speed: index$1.number,
    /**
     ...
     *
     */
    direction: index$1.oneOf(['vertical', 'horizontal']),
    /**
     * show indicators
     *
     */
    indicators: index$1.bool,
    /**
...
Gallery.propTypes = {
     ...
     *
     */
    src: index$1.oneOfType([index$1.string, index$1.array]),
    /**
     * indicate whather the component is display
     *
     */
...
LoadMore$1.propTypes = {
     ...
     *
     */
    loading: index$1.bool,
    /**
     * display side lines
     *
     */
    showLine: index$1.bool,
    /**
     * display dot in the center
     *
     */
    showDot: index$1.bool
};
...
PickerGroup.propTypes = {
    height: index$1.number,
    itemHeight: index$1.number,
    indicatorTop: index$1.number,
    indicatorHeight: index$1.number,
    onChange: index$1.func,
    aniamtion: index$1.bool,
    groupIndex: index$1.number,
    defaultIndex: index$1.number
};
...
PopupHeader.propTypes = {
   ...
   *
   */
  right: index$1.string,
  /**
   * left button onclick
   *
   */
  leftOnClick: index$1.func,
  /**
   * right button onclick
   *
   */
  rightOnClick: index$1.func
};
...
Page$1.propTypes = {
     ...
     *
     */
    ptrOnRefresh: index$1.func,
    /**
     * indicate to use infiniteloader
     *
     */
    infiniteLoader: index$1.bool,
    /**
     * callback when it's requesting for more content, pass resolve function and finish function
     *
     */
